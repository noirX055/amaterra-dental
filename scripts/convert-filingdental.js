...
const inputPath = path.join(publicDir, 'filingdental.jpg');
const outputPath = path.join(publicDir, 'filingdental.webp');

const convertImage = async () => {
  try {
    console.log('🖼️  Конвертация filingdental.jpg в WebP...\n');
    ...
    console.log(`✓ filingdental.jpg → filingdental.webp`);
